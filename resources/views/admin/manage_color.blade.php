  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">color manager</h3>
      ...
      <div class="card-body">
        <form role="form" action="{{route('color.manage_color_process')}}" method="post" enctype="multipart/form-data">
          @csrf
             <div class="form-group">
              <label for="category_name">color Name</label>
               <input type="text" class="form-control @error('name') is-invalid @enderror" id="category_name" name="name" value="{{$name}}{{old('name')}}" placeholder="Enter color name">
               @error('color')
             ...
             <div class="form-group">
              <label for="category_name">Code</label>
               <input type="text" class="form-control @error('code') is-invalid @enderror" id="category_name" name="code" value="{{$code}}{{old('code')}}" placeholder="Enter code ex:- #000">
               @error('code')
                 <span class="error invalid-feedback">
                   {{$message}}
                 </span>
