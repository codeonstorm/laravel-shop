      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{url('admin/deshboard')}}" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/category/manage_category')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage category</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/size/manage_size')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage sizes</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/color/manage_color')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage colors</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/brand/manage_brand')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage brands</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/coupon/manage_coupon')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage coupons</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/product/manage_product')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>manage products</p>
                </a>
              </li>
