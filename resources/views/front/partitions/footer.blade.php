          ...
          <div class="py-4 service-column col-lg-3 col-sm-6">
            ...
            <div class="py-4 service-column col-lg-3 col-sm-6">
              ...
              <div class="py-5 text-muted">
                <div class="container">
                  <div class="row">
                    <div class="pe-lg-5 pe-xl-6 mb-5 mb-lg-0 col-lg-5">
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-none collapsed-card">
                                      <div class="card-header p-0">
                                          ...
                                          <h6 class="card-title text-dark letter-spacing mb-lg-4">Shop</h6>
                                          <button type="button" class="btn btn-tool d-lg-none  text-dark" data-card-widget="collapse"
                                          style="float:right; font-size:22px;"><i class="fas fa-plus"></i>
                                          </button>
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-none collapsed-card">
                                      <div class="card-header p-0">
                                          ...
                                          <h6 class="card-title text-dark letter-spacing mb-lg-4">Company</h6>
                                          <button type="button" class="btn btn-tool d-lg-none  text-dark" data-card-widget="collapse"
                                          style="float:right; font-size:22px;"><i class="fas fa-plus"></i>
                                          </button>
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-none collapsed-card">
                                      <div class="card-header p-0">
                                          ...
                                          <h6 class="card-title text-dark letter-spacing mb-lg-4">Your account</h6>
                                          <button type="button" class="btn btn-tool d-lg-none  text-dark" data-card-widget="collapse"
                                          style="float:right; font-size:22px;"><i class="fas fa-plus"></i>
                                          </button>
                                    ...
                                    <div class="py-4 fw-light text-muted">
                                      <div class="container">
                                        <div class="align-items-center text-sm text-gray-500 row">
                                          <div class="text-center text-lg-start col-lg-4">
                                            <p class="mb-lg-0">© <!-- -->2022<!-- --> Your company. All rights reserved.</p>
                                          </div>
                                          <div class="col-lg-8">
