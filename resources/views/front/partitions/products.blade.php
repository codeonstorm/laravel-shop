...
<!--product-->
  ...
  <img alt="product" src="http://127.0.0.1:8000/storage/media/product/229166160.jpg" decoding="async" data-nimg="responsive" class="img-fluid" style="position:absolute;top:0;left:0;bottom:0;right:0;
           ...
           <a class="text-dark text-hover-primary me-2" href="#" aria-label="add to wishlist">
             ...
             <a class="text-dark text-hover-primary text-decoration-none" href="#" aria-label="open quickview"><svg class="svg-icon svg-icon-heavy">
               ...
               <div class="position-relative"><h3 class="text-base mb-1">
                 <a class="text-dark" href="http://127.0.0.1:8000/product/cuet-examination-book-2022">CUET Examination</a>
               </h3>
               <span style="font-weight:700 !important; font-size:1.3rem !important;
                line-height:1.25 !important; color:#812704 !important;">₹7777</span>
                <span style="text-decoration:line-through !important;
                font-size:1.1rem !important; line-height:1.5 !important;
                color:#555 !important;">₹7777</span>
         ...
         <div>
           <a class="text-dark text-hover-primary me-2" href="#" aria-label="add to wishlist">
             ...
             <a class="text-dark text-hover-primary text-decoration-none" href="#" aria-label="open quickview"><svg class="svg-icon svg-icon-heavy">
               ...
               <div class="position-relative"><h3 class="text-base mb-1">
                 <a class="text-dark" href="http://127.0.0.1:8000/product/ankit">ankit</a>
               </h3>
               <span style="font-weight:700 !important; font-size:1.3rem !important;
                line-height:1.25 !important; color:#812704 !important;">₹34</span>
                <span style="text-decoration:line-through !important;
                font-size:1.1rem !important; line-height:1.5 !important;
                color:#555 !important;">₹34</span>
