...
@php
  ...
  if($errors->status ){
    //echo "<script>alert('please fill correct!')</script>";
  }
@endphp

@if($rating_err) <center style="color:red">*{{$rating_err}} for rating</center> @endif
<div class="content">
      <div class="container">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 col-sm-5">
                  ...
                  <div class="col-md-8 col-sm-10" style="margin:0 auto;">
                  ...
                  @if(count($product_attr_img[$product_attr[$id]->id])>1)
                  @foreach($product_attr_img[$product_attr[$id]->id] as $key => $img)
                    <div class="product-image-thumb @if(!$key) active @endif"><img src="{{asset('storage/media/product/'.$img->img)}}" alt="Product Image"></div>
                  @endforeach
                  @endif
                  </div>
                </div>
                <div class="col-12 col-sm-7" style="padding-left: 9%;">
                  <h3 class="my-3 p-name d-none d-sm-inline">{{$product->name}}</h3>
                  <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-sm-between mb-4">
                    <ul class="list-inline mb-2 mb-sm-0"><li class="list-inline-item h4 fw-light mb-0" style="color:#812704;">₹<!-- -->{{$product_attr[$id]->price}}</li>
                    ...
                    <div class="row">
                      <div class="detail-option mb-4 col-lg-12 col-sm-6">
                        ...
                        <div class="mt-3 input-group" style="width:55%">
                          <input type="number" name="qty" id="qty" class="detail-quantity form-control form-control-lg" min="0" max="7" value="1">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <a class="text-muted" href="{{url('category/'.$product->cat_slug)}}">
                            {{$product->category}}
                          </a>
                        </li>
                          <li><strong>Tags:&nbsp;</strong>
                            <!-- <a class="text-muted" href="#">Leisure</a>,&nbsp; -->
                          </li>
                        </ul>
              ...
              <div class="row mt-4">
                <nav class="w-100">
                  <div class="nav nav-tabs" id="product-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="product-comments-tab" data-info="{{$product_attr[$id]->id}}" data-toggle="tab" href="#product-comments" role="tab" aria-controls="product-comments" aria-selected="false" data-features="false">ADDITIONAL INFORMATION</a>
                    <a class="nav-item nav-link" id="product-rating-tab" data-info="{{$product_attr[$id]->id}}" data-toggle="tab" href="#product-rating" role="tab" aria-controls="product-rating" aria-selected="false" data-rating="false">reviews / Rating</a>
                  </div>
                </nav>
                <div class="tab-content p-3 w-100" id="nav-tabContent">
                  ...
                  <div class="tab-pane text-muted fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab">
                    <div class="row" id="features_data">
...
@section('footer')
  ...
  function add_to_cart(){
    ...
    jQuery.ajax({
      type:'post',
      url:'/add_to_cart',
      data:'product_attr_id='+pAttrId+'&slug='+slug+'&'+jQuery('#frmAddToCart').serialize(),
